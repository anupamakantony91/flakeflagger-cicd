...
tests = [
    ...
    {"test_name": "test_list_comprehension",
     "ExecutionTime": 0.05, "testLength": 5, "numAsserts": 3,
     "numCoveredLines": 15, "projectSourceLinesCovered": 45,
     "projectSourceClassesCovered": 3},
    {"test_name": "test_nested_loops",
     "ExecutionTime": 0.08, "testLength": 6, "numAsserts": 1,
     "numCoveredLines": 20, "projectSourceLinesCovered": 60,
     "projectSourceClassesCovered": 3},
    {"test_name": "test_string_operations_medium",
     "ExecutionTime": 0.02, "testLength": 5, "numAsserts": 2,
     "numCoveredLines": 12, "projectSourceLinesCovered": 35,
     "projectSourceClassesCovered": 2},
    {"test_name": "test_dictionary_operations",
     "ExecutionTime": 0.05, "testLength": 6, "numAsserts": 2,
     "numCoveredLines": 18, "projectSourceLinesCovered": 50,
     "projectSourceClassesCovered": 3},
    {"test_name": "test_list_filter",
     "ExecutionTime": 0.03, "testLength": 4, "numAsserts": 1,
     "numCoveredLines": 10, "projectSourceLinesCovered": 30,
     "projectSourceClassesCovered": 2},
    {"test_name": "test_string_join",
     "ExecutionTime": 0.04, "testLength": 5, "numAsserts": 2,
     "numCoveredLines": 12, "projectSourceLinesCovered": 35,
     "projectSourceClassesCovered": 2},
    {"test_name": "test_math_operations",
     "ExecutionTime": 0.05, "testLength": 5, "numAsserts": 2,
     "numCoveredLines": 15, "projectSourceLinesCovered": 40,
     "projectSourceClassesCovered": 3},
    {"test_name": "test_set_operations",
     "ExecutionTime": 0.04, "testLength": 5, "numAsserts": 1,
     "numCoveredLines": 12, "projectSourceLinesCovered": 35,
     "projectSourceClassesCovered": 2},
    {"test_name": "test_tuple_operations",
     "ExecutionTime": 0.02, "testLength": 4, "numAsserts": 3,
     "numCoveredLines": 10, "projectSourceLinesCovered": 30,
     "projectSourceClassesCovered": 2},
    {"test_name": "test_sorted_large_list",
     "ExecutionTime": 0.10, "testLength": 6, "numAsserts": 2,
     "numCoveredLines": 20, "projectSourceLinesCovered": 55,
     "projectSourceClassesCovered": 3},
    # Group 3 — Higher risk tests
    {"test_name": "test_execution_time_medium",
     "ExecutionTime": 0.85, "testLength": 7, "numAsserts": 2,
     "numCoveredLines": 40, "projectSourceLinesCovered": 180,
     "projectSourceClassesCovered": 8},
    {"test_name": "test_large_list_processing",
     "ExecutionTime": 1.20, "testLength": 6, "numAsserts": 1,
     "numCoveredLines": 55, "projectSourceLinesCovered": 220,
     "projectSourceClassesCovered": 9},
    {"test_name": "test_string_manipulation_large",
     "ExecutionTime": 0.95, "testLength": 6, "numAsserts": 1,
     "numCoveredLines": 45, "projectSourceLinesCovered": 190,
     "projectSourceClassesCovered": 8},
    {"test_name": "test_nested_dict_operations",
     "ExecutionTime": 1.50, "testLength": 8, "numAsserts": 2,
     "numCoveredLines": 65, "projectSourceLinesCovered": 280,
     "projectSourceClassesCovered": 12},
    {"test_name": "test_recursive_computation",
     "ExecutionTime": 2.10, "testLength": 7, "numAsserts": 1,
     "numCoveredLines": 70, "projectSourceLinesCovered": 310,
     "projectSourceClassesCovered": 14},
    {"test_name": "test_multiple_iterations",
     "ExecutionTime": 1.80, "testLength": 6, "numAsserts": 1,
     "numCoveredLines": 60, "projectSourceLinesCovered": 260,
     "projectSourceClassesCovered": 11},
    {"test_name": "test_string_search_large",
     "ExecutionTime": 1.30, "testLength": 6, "numAsserts": 2,
     "numCoveredLines": 55, "projectSourceLinesCovered": 230,
     "projectSourceClassesCovered": 10},
    {"test_name": "test_list_operations_large",
     "ExecutionTime": 1.60, "testLength": 7, "numAsserts": 4,
     "numCoveredLines": 65, "projectSourceLinesCovered": 270,
     "projectSourceClassesCovered": 12},
    {"test_name": "test_execution_time_with_sleep",
     "ExecutionTime": 2.50, "testLength": 6, "numAsserts": 2,
     "numCoveredLines": 85, "projectSourceLinesCovered": 420,
     "projectSourceClassesCovered": 18},
    {"test_name": "test_covers_many_modules",
     "ExecutionTime": 1.80, "testLength": 9, "numAsserts": 5,
     "numCoveredLines": 90, "projectSourceLinesCovered": 450,
     "projectSourceClassesCovered": 20},
    # ── FLAKY TEST SIMULATION ─────────────────────────────
    # Feature values copied from real flaky test in logback
    # project (Bell et al. 2021). This test scored 100%
    # flaky probability from the trained model locally.
    # Key flakiness indicators: assertion-roulette=1,
    # indirect-testing=1, mystery-guest=1
...
print("-" * 55)
print(f"{'Test Name':<35} {'Risk':>6} {'Status':>14}")
print("-" * 55)

flaky_count = 0
results = []

for name, pred, prob in zip(test_names, predictions,
                             probabilities):
...
# Save results as pipeline artefact
